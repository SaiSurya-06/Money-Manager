"""
Base settings for MoneyManager project.
"""
...
LOCAL_APPS = [
    'moneymanager.apps.accounts',
    'moneymanager.apps.transactions',
    'moneymanager.apps.budgets',
    'moneymanager.apps.portfolios',
    'moneymanager.apps.dashboard',
    'moneymanager.apps.imports',
    'moneymanager.apps.core',
]
...
MIDDLEWARE = [
    ...
    'moneymanager.apps.core.middleware.FamilyGroupMiddleware',
]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'moneymanager.apps.core.context_processors.family_group_context',
            ],
        },
    },
]
